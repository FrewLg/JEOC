 ...
 */
final class Version20210527111720 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE directorate_office (id INT AUTO_INCREMENT NOT NULL, name VARCHAR(500) DEFAULT NULL, mission LONGTEXT DEFAULT NULL, description LONGTEXT DEFAULT NULL, contact_address LONGTEXT DEFAULT NULL, objective LONGTEXT DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('DROP TABLE directorate_office');
    }
}
