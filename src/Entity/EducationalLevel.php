...
class EducationalLevel
{
    ...
    /**
     * @ORM\OneToMany(targetEntity=UserInfo::class, mappedBy="education_level")
     */
    private $userInfos;
    ...
    public function addUserInfo(UserInfo $userInfo): self
    {
        if (!$this->userInfos->contains($userInfo)) {
            ...
            $userInfo->setEducationLevel($this);
        }
    ...
    public function removeUserInfo(UserInfo $userInfo): self
    {
        if ($this->userInfos->removeElement($userInfo)) {
            ...
            if ($userInfo->getEducationLevel() === $this) {
                $userInfo->setEducationLevel(null);
            }
        }
